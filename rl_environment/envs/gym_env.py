...
class HospitalGymEnv(gym.Env):
    ...
    def __init__(
        ...
        self._env = HospitalEnv(
            ...
            doctor_betas=doctor_betas,
            reward_alpha=reward_alpha,
            reward_t_max=reward_t_max,
            reward_mu=reward_mu,
    ...
    def from_yaml(cls, config_path: str) -> "HospitalGymEnv":
        ...
        return cls(
            ...
            doctor_betas=env.get("doctor_betas", [2.0]),
            reward_alpha=env.get("reward_alpha", 2.0),
            reward_t_max=env.get("reward_t_max", 10.0),
            reward_mu=env.get("reward_mu", 1.5),
